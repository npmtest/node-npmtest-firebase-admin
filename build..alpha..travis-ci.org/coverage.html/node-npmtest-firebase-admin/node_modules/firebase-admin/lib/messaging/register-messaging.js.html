...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-firebase-admin/node_modules/firebase-admin/lib/messaging/register-messaging.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-firebase-admin/node_modules/firebase-admin/lib/messaging/register-messaging.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-firebase-admin/node_modules/firebase-admin/lib/messaging/</a> &#187; register-messaging.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function serviceFactory(app, extendApp) {</span>
<span class="cstat-no" title="statement not covered" >    return new messaging_1.Messaging(app);</span>
}
/**
 ...
 */
var appHook = <span class="fstat-no" title="function not covered" >function (event, app) {</span>
