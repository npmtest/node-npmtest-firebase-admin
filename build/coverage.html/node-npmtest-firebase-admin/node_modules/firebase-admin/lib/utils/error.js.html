...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-firebase-admin/node_modules/firebase-admin/lib/utils/error.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-firebase-admin/node_modules/firebase-admin/lib/utils/error.js</span></h1>
    <h2>
        
        Statements: <span class="metric">76.86% <small>(93 / 121)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-firebase-admin/node_modules/firebase-admin/lib/utils/</a> &#187; error.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function FirebaseError(errorInfo) {</span>
<span class="cstat-no" title="statement not covered" >        var _this = _super.call(this, errorInfo.message) || this;</span>
<span class="cstat-no" title="statement not covered" >        _this.errorInfo = errorInfo;</span>
        /* tslint:disable:max-line-length */
        // Set the prototype explicitly. See the following link for more details:
        // https://github.com/Microsoft/TypeScript/wiki/Breaking-Changes#extending-built-ins-like-error-array-and-map-may-no-longer-work
        /* tslint:enable:max-line-length */
<span class="cstat-no" title="statement not covered" >        _this.__proto__ = FirebaseError.prototype;</span>
...
<span class="cstat-no" title="statement not covered" >            return this.errorInfo.code;</span>
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FirebaseError.prototype, "message", {
        ...
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this.errorInfo.message;</span>
        },
        enumerable: true,
        configurable: true
    });
    /** @return {Object} The object representation of the error. */
    FirebaseError.prototype.toJSON = <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="fstat-no" title="function not covered" >    function FirebaseAppError(code, message) {</span>
...
<span class="fstat-no" title="function not covered" >    function FirebaseAuthError(info, message) {</span>
        // Override default message if custom message provided.
<span class="cstat-no" title="statement not covered" >        return _super.call(this, { code: 'auth/' + info.code, message: message || info.message }) || this;</span>
    }
    /**
     ...
     */
    FirebaseAuthError.fromServerError = <span class="fstat-no" title="function not covered" >function (serverErrorCode, message, rawServerResponse) {</span>
        // If not found, default to internal error.
<span class="cstat-no" title="statement not covered" >        var clientCodeKey = AUTH_SERVER_TO_CLIENT_CODE[serverErrorCode] || 'INTERNAL_ERROR';</span>
<span class="cstat-no" title="statement not covered" >        var error = deep_copy_1.deepCopy(AuthClientErrorCode[clientCodeKey]);</span>
<span class="cstat-no" title="statement not covered" >        error.message = message || error.message;</span>
<span class="cstat-no" title="statement not covered" >        if (clientCodeKey === 'INTERNAL_ERROR' &amp;&amp; typeof rawServerResponse !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                error.message += " Raw server response: \"" + JSON.stringify(rawServerResponse) + "\"";</span>
            }
            catch (e) {
                // Ignore JSON parsing error.
            }
        }
<span class="cstat-no" title="statement not covered" >        return new FirebaseAuthError(error);</span>
    };
...
<span class="fstat-no" title="function not covered" >    function FirebaseMessagingError(info, message) {</span>
        // Override default message if custom message provided.
<span class="cstat-no" title="statement not covered" >        return _super.call(this, { code: 'messaging/' + info.code, message: message || info.message }) || this;</span>
    }
    /**
     * Creates the developer-facing error corresponding to the backend error code.
     *
     ...
     */
    FirebaseMessagingError.fromServerError = <span class="fstat-no" title="function not covered" >function (serverErrorCode, message, rawServerResponse) {</span>
        // If not found, default to unknown error.
<span class="cstat-no" title="statement not covered" >        var clientCodeKey = MESSAGING_SERVER_TO_CLIENT_CODE[serverErrorCode] || 'UNKNOWN_ERROR';</span>
<span class="cstat-no" title="statement not covered" >        var error = deep_copy_1.deepCopy(MessagingClientErrorCode[clientCodeKey]);</span>
<span class="cstat-no" title="statement not covered" >        error.message = message || error.message;</span>
<span class="cstat-no" title="statement not covered" >        if (clientCodeKey === 'UNKNOWN_ERROR' &amp;&amp; typeof rawServerResponse !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                error.message += " Raw server response: \"" + JSON.stringify(rawServerResponse) + "\"";</span>
            }
            catch (e) {
...
<span class="cstat-no" title="statement not covered" >        return new FirebaseMessagingError(error);</span>
    };
...
<span class="fstat-no" title="function not covered" >    function AppErrorCodes() {</span>
    }
...
<span class="fstat-no" title="function not covered" >    function AuthClientErrorCode() {</span>
    }
...
<span class="fstat-no" title="function not covered" >    function MessagingClientErrorCode() {</span>
    }
